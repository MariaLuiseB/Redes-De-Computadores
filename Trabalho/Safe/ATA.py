...
def register_with_name_server():
    ...
    broadcast_socket.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1) # Permite reutilizar o endereço
    broadcast_socket.setsockopt(socket.SOL_SOCKET, socket.SO_BROADCAST, 1) # Permite enviar broadcast
